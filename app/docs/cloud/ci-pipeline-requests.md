...
| 4   | Passo `yarn prettier:check`                                                                                                                                       | O hook formata na máquina do dev, mas commit feito fora do agente passa sem formato. **Depende** do commit `style:` que formata os 39 arquivos hoje fora do padrão; antes disso o passo falharia | P       |
